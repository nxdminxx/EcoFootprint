...
public class ElectricityController {
    ...
    public String viewAddElectricityForm(Model model) {
        ...
        model.addAttribute("electricity", new Electricity(0, 0, 0, 0, null, null, null, 0, null));
    ...
    try {
        ...
        Electricity electricity = new Electricity(0,ElectricityNumOfDaysData, ElectricityUsageRMData, ElectricityUsageKWHData,ElectricityMethods, ElectricityPractices, ElectricityMonth, ElectricityPropFactorData, ElectricityBillData);
